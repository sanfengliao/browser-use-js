export const CHROME_EXTENSIONS = {} // coming in a separate PR
...
export const CHROME_ARGS = [
  ...
  // `--user-data-dir=${CHROME_PROFILE_PATH}`,     // managed by playwright arg instead
  ...
  // `--allowlisted-extension-id=${Object.keys(CHROME_EXTENSIONS).join(',')}`,
